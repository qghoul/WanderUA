...
Technologies: Java; Spring (Boot, Security, Data JPA, MVC); ORM Hibernate; Lombook; PostgreSQL; Maven; JSON; CSS; Vanilla JS; HTML; FreeMarker. IDE: Intellij IDEA. Ai-assistant: Claude.
Design documentaion: Business requirements specification; Software requirements specification; UML-diagrams (Use-case diagrams; sequence diagrams; deployment diagram; class diagram); ERD-digram.  
